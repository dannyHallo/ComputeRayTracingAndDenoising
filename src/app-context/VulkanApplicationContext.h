...
private:
  struct QueueFamilyIndices {
    // The wrapper optional can call .hasValue to determine whether this var is assigned or not.

    // Although they are mostly the same, it's actually possible that the queue families supporting drawing commands and the ones
    // supporting presentation do not overlap.
