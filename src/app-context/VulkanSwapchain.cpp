...
const VkSwapchainKHR &VulkanSwapchain::getBody() const { return m_vkbSwapchain.swapchain; }

const VkExtent2D &VulkanSwapchain::getExtent() const { return m_vkbSwapchain.extent; }

const VkFormat &VulkanSwapchain::getFormat() const { return m_vkbSwapchain.image_format; }
