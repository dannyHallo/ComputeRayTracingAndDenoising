...
const std::unordered_map<int, std::string> resultCodeNamePair = {
    ...
    {VK_ERROR_FRAGMENTED_POOL,
     "A pool allocation has failed due to fragmentation of the pool’s memory. This must only be returned if no attempt to "
     "allocate host or device memory was made to accommodate the new allocation. If the failure was definitely due to "
     "fragmentation of the pool, VK_ERROR_FRAGMENTED_POOL should be returned. If the allocation could have failed due to "
     "either fragmentation of the pool or an attempt to allocate host or device memory failing (due to heap exhaustion or "
     "platform limits), VK_ERROR_OUT_OF_POOL_MEMORY should be returned instead."},
    {VK_ERROR_UNKNOWN, "An unknown error has occurred; either the application has provided invalid input, or an implementation "
    ...
    {VK_ERROR_OUT_OF_POOL_MEMORY,
     ...
     "to accommodate the new allocation. This should be returned in preference to VK_ERROR_OUT_OF_HOST_MEMORY or "
     "VK_ERROR_OUT_OF_DEVICE_MEMORY, but only if the implementation is certain of the cause."},
    ...
    {VK_PIPELINE_COMPILE_REQUIRED, "Indicates that a pipeline creation would have required compilation if the compiled state "
    ...
    {VK_ERROR_OUT_OF_DATE_KHR,
     ...
     "requests using the swapchain will fail. Applications must query the new surface properties and recreate their swapchain "
     "if they wish to continue presenting to the surface."},
    {VK_ERROR_INCOMPATIBLE_DISPLAY_KHR, "The display used by a swapchain does not use the same presentable image layout, or is "
    ...
    {VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR,
     "The image usage flags specified in VkImageCreateInfo are not supported for this image format on this platform."}
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
    ,
    {VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR,
     "The video picture layout specified in VkVideoPictureResourceKHR::pictureFormat is not supported for this video codec on "
     "this platform."}
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
    ,
    {VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR,
     "The video profile operation specified in VkVideoProfileKHR::videoCodecOperation is not supported for this video codec on "
     "this platform."}
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
    ,
    {VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR, "The video profile format specified in VkVideoProfileKHR::videoFormat is "
                                                      "not supported for this video codec on this platform."}
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
    ,
    {VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR,
     "The video profile codec specified in VkVideoProfileKHR::videoCodec is not supported on this platform."}
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
    ,
    {VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR, "The video standard version specified in VkVideoProfileKHR::videoStdVersion "
                                                   "is not supported for this video codec on this platform."},
#endif
    {VK_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT,
     "The DRM format modifier plane layout specified in VkImageDrmFormatModifierExplicitCreateInfoEXT is not supported by the "
     "device."},
    ...
    {VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT,
     ...
     "exlusive full-screen access. This may occur due to implementation-dependent reasons, outside of the application’s "
     "control."},
    {VK_THREAD_IDLE_KHR,
    ...
    {VK_ERROR_COMPRESSION_EXHAUSTED_EXT, "The compressed data provided to the API was exhausted before the operation completed."},
    {VK_ERROR_OUT_OF_POOL_MEMORY_KHR,
     "A pool memory allocation has failed. This must only be returned if no attempt to allocate host or device memory was made "
     "to accommodate the new allocation. This should be returned in preference to VK_ERROR_OUT_OF_HOST_MEMORY or "
     "VK_ERROR_OUT_OF_DEVICE_MEMORY, but only if the implementation is certain of the cause."},
    {VK_ERROR_INVALID_EXTERNAL_HANDLE_KHR, "An external handle is not a valid handle of the specified type"},
    ...
    {VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS_KHR,
     "A buffer creation or memory allocation failed because the requested address is not available. A shader group handle "
     "assignment failed because the requested shader group handle information is no longer valid."},
    {VK_PIPELINE_COMPILE_REQUIRED_EXT, "Indicates that a pipeline creation would have required compilation if the compiled "
                                       "state was not already available in cache."},
    {VK_ERROR_PIPELINE_COMPILE_REQUIRED_EXT, "Indicates that a pipeline creation would have required compilation if the "
