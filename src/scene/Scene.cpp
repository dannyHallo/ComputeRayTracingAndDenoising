...
void Scene::_initForwardRenderPass() { m_RenderPass = std::make_shared<ForwardRenderPass>(); }

void Scene::_initFlatRenderPass() { m_RenderPass = std::make_shared<FlatRenderPass>(); }
...
std::shared_ptr<RenderPass> Scene::getRenderPass() { return m_RenderPass; }
