...
std::shared_ptr<VkFramebuffer> ForwardRenderPass::getFramebuffer(size_t index) { return m_framebuffer; }
...
std::shared_ptr<Image> ForwardRenderPass::getDepthImage() { return m_depthImage; }
